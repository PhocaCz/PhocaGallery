...
/*
	...
	public static function renderCreateFolder($sessName, $sessId, $currentFolder, $viewBack, $attribs = '') {
		...
		.'folder='.htmlspecialchars(PhocaGalleryText::removeSpecChars($currentFolder.$attribs)) .'" name="folderForm" id="folderForm" method="post">'
		...
		.'<input class="update-folder" type="hidden" name="folderbase" id="folderbase" value="'.htmlspecialchars(PhocaGalleryText::removeSpecChars($currentFolder)).'" />'
